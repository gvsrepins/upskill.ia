            ...
            <div class="relative rounded-xl border p-10 border-neutral-200 dark:border-neutral-700">
                <div class="container w-fit">
                    ...
                    @foreach($plan['identified_gaps'] as $gap)
                        ...
                        <div class="mb-8 p-4 border rounded-lg border-neutral-300 dark:border-neutral-600 shadow-m">
                            <h2 class="text-2xl font-semibold">{{ $gap['competency'] }}</h2>
                            <p class="text-neutral-500 dark:text-neutral-400 mb-2">Nível atual: {{ $gap['current_level'] }}</p>

                            <div class="mb-4">
                                <h3 class="text-xl font-medium">Ações:</h3>
                            ...
                            <div class="mb-4">
                                <h3 class="text-xl font-medium">Recursos sugeridos:</h3>
                                <ul class="list-disc list-inside">
                            ...
                            <div class="mb-4">
                                <h3 class="text-xl font-medium">Tempo estimado:</h3>
                                <p>{{ $gap['action_plan']['estimated_time'] }}</p>
                            </div>

                            <div>
                                <h3 class="text-xl font-medium">Métrica de progresso:</h3>
